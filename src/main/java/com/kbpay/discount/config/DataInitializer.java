    ...
    private void initProducts() {
        ...
        List<Product> products = List.of(
            ...
            build("홈플러스 상품권 1만원","HOMEPLUS",10000,7000,30,150,"쇼핑","new",654,4.4,43,
                ...
                "• 온라인몰 사용 불가\n• 잔액 환불 불가", 98, 30),
            build("할리스 아메리카노 10잔","HOLLYS",24000,15600,35,120,"카페","new",1876,4.6,134,
            ...
            build("CU 편의점 상품권 5천원","CU",5000,3500,30,200,"음식","new",2341,4.2,198,
                ...
                "• 일부 상품 제외\n• 잔액 환불 불가", 127, 14),
            build("맘스터치 싸이버거 세트 2인","MOMS TOUCH",14000,9100,35,100,"음식","end",432,4.5,67,
                "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&q=80",
                "🍔 정가 14,000원 → 9,100원 (35% 할인)\n\n맘스터치 싸이버거 세트 2인 교환권\n\n✅ 전국 맘스터치 매장 사용\n✅ 발급일로부터 30일 유효",
                "• 딜리버리 제외, 매장/포장 전용\n• 세트 구성 변경 불가", 8, 30),
