...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initProducts() {
        ...
        List<Product> products = List.of(
            // ── 카페 (오프라인) ──
            build("스타벅스 바로할인","STARBUCKS",15000,99999999,7,150,"카페","hot",8421,4.8,234,
                "https://images.unsplash.com/photo-1541167760496-1628856ab772?w=400&q=80",
                "☕ KB페이로 결제 시 7% 할인\n\n✅ 15,000원 이상 결제 시 사용 가능\n✅ 결제금액에 따라 할인 적용 (한도 없음)\n✅ 전국 스타벅스 직영점",
                "• 타 할인/쿠폰/적립과 중복 적용 불가\n• 인천공항점, 면세점 등 일부 특수 매장 사용 불가\n• 음료·푸드 전 메뉴 적용", 98, 30),
            build("투썸플레이스 바로할인","A TWOSOME PLACE",12000,99999999,7,100,"카페","new",3241,4.6,98,
                "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=400&q=80",
                "🎂 KB페이로 결제 시 7% 할인\n\n✅ 12,000원 이상 결제 시 사용 가능\n✅ 결제금액에 따라 할인 적용 (한도 없음)\n✅ 전국 투썸플레이스 매장",
                "• 타 할인/쿠폰과 중복 적용 불가\n• 인천공항점 등 특수 매장 제외\n• 음료·케이크 전 메뉴 적용", 74, 30),
            build("파리바게뜨 바로할인","PARIS BAGUETTE",10000,99999999,6,120,"카페","",2187,4.5,76,
                "https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?w=400&q=80",
                "🥐 KB페이로 결제 시 6% 할인\n\n✅ 10,000원 이상 결제 시 사용 가능\n✅ 결제금액에 따라 할인 적용 (한도 없음)\n✅ 전국 파리바게뜨 매장",
                "• 타 할인과 중복 적용 불가\n• 고속도로 휴게소·면세점 제외\n• 빵·케이크·음료 전 품목 적용", 67, 30),
            build("배스킨라빈스 바로할인","BASKIN ROBBINS",8000,99999999,8,120,"카페","",4312,4.7,112,
                "https://images.unsplash.com/photo-1497034825429-c343d7c6a68f?w=400&q=80",
                "🍦 KB페이로 결제 시 8% 할인\n\n✅ 8,000원 이상 결제 시 사용 가능\n✅ 결제금액에 따라 할인 적용 (한도 없음)\n✅ 전국 배스킨라빈스 매장",
                "• 타 할인/쿠폰과 중복 적용 불가\n• 인천공항점·면세 구역 제외\n• 아이스크림·케이크 전 메뉴 적용", 78, 30),
            build("탐앤탐스 바로할인","TOM N TOMS",10000,10000,5,100,"카페","new",1543,4.5,67,
                "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&q=80",
                "☕ KB페이로 결제 시 5% 할인\n\n✅ 10,000원 이상 결제 시 사용 가능\n✅ 최대 10,000원\n✅ 전국 탐앤탐스 매장",
                "• 타 할인과 중복 적용 불가\n• 일부 특수 매장 제외\n• 음료 전 메뉴 적용", 55, 30),

            // ── 음식 (오프라인) ──
            build("버거킹 바로할인","BURGER KING",15000,10000,8,100,"음식","hot",5621,4.6,156,
                "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&q=80",
                "🍔 KB페이로 결제 시 8% 할인\n\n✅ 15,000원 이상 결제 시 사용 가능\n✅ 최대 10,000원\n✅ 전국 버거킹 매장",
                "• 타 할인/쿠폰과 중복 적용 불가\n• 인천공항점·고속도로 휴게소 제외\n• 세트·단품·사이드 전 메뉴 적용", 67, 30),
            build("피자헛 바로할인","PIZZA HUT",20000,99999999,9,80,"음식","hot",3421,4.6,89,
                "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=400&q=80",
                "🍕 KB페이로 결제 시 9% 할인\n\n✅ 20,000원 이상 결제 시 사용 가능\n✅ 결제금액에 따라 할인 적용 (한도 없음)\n✅ 전국 피자헛 매장",
                "• 타 할인/쿠폰과 중복 적용 불가\n• 인천공항점·면세점 제외\n• 피자·파스타·사이드 전 메뉴 적용", 44, 30),
            build("맥도날드 바로할인","MCDONALDS",12000,5000,6,150,"음식","",4312,4.5,102,
                "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&q=80",
                "🍔 KB페이로 결제 시 6% 할인\n\n✅ 12,000원 이상 결제 시 사용 가능\n✅ 최대 5,000원\n✅ 전국 맥도날드 매장",
                "• 타 할인/쿠폰과 중복 적용 불가\n• 인천공항·고속도로 휴게소점 제외\n• 딜리버리 포함 전 메뉴 적용", 89, 30),
            build("KFC 바로할인","KFC",13000,5000,7,80,"음식","",1876,4.5,58,
                "https://images.unsplash.com/photo-1626645738196-c2a7c87a8f58?w=400&q=80",
                "🍗 KB페이로 결제 시 7% 할인\n\n✅ 13,000원 이상 결제 시 사용 가능\n✅ 최대 5,000원\n✅ 전국 KFC 매장",
                "• 타 할인과 중복 적용 불가\n• 인천공항점·고속도로 휴게소 제외\n• 버킷·세트·단품 전 메뉴 적용", 42, 30),
            build("도미노피자 바로할인","DOMINOS",20000,99999999,10,60,"음식","hot",2341,4.6,95,
                "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=400&q=80",
                "🍕 KB페이로 결제 시 10% 할인\n\n✅ 20,000원 이상 결제 시 사용 가능\n✅ 결제금액에 따라 할인 적용 (한도 없음)\n✅ 전국 도미노피자 매장",
                "• 타 할인/쿠폰과 중복 적용 불가\n• 인천공항점·면세점 제외\n• 피자·사이드·음료 전 메뉴 적용", 38, 30),
            build("서브웨이 바로할인","SUBWAY",8000,3000,6,100,"음식","hot",1987,4.4,89,
                "https://images.unsplash.com/photo-1509722747041-616f39b57569?w=400&q=80",
                "🥪 KB페이로 결제 시 6% 할인\n\n✅ 8,000원 이상 결제 시 사용 가능\n✅ 최대 3,000원\n✅ 전국 서브웨이 매장",
                "• 타 할인과 중복 적용 불가\n• 인천공항점·고속도로점 제외\n• 샌드위치·음료·쿠키 전 메뉴 적용", 67, 30),
            build("쉐이크쉑 바로할인","SHAKE SHACK",18000,10000,7,50,"음식","end",987,4.8,67,
                "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&q=80",
                "🍔 KB페이로 결제 시 7% 할인\n\n✅ 18,000원 이상 결제 시 사용 가능\n✅ 최대 10,000원\n✅ 전국 쉐이크쉑 매장",
                "• 타 할인/쿠폰과 중복 적용 불가\n• 인천공항점·면세 구역 제외\n• 버거·쉐이크·사이드 전 메뉴 적용", 12, 30),
            build("CU 바로할인","CU",5000,2000,5,200,"음식","new",6543,4.2,198,
                "https://images.unsplash.com/photo-1555126634-323283e090fa?w=400&q=80",
                "🏪 KB페이로 결제 시 5% 할인\n\n✅ 5,000원 이상 결제 시 사용 가능\n✅ 최대 2,000원\n✅ 전국 CU 편의점",
                "• 타 할인과 중복 적용 불가\n• 담배·교통카드 충전·공과금 제외\n• 식품·음료·생활용품 전 품목 적용", 145, 30),
            build("GS25 바로할인","GS25",5000,2000,5,200,"음식","hot",7213,4.3,289,
                "https://images.unsplash.com/photo-1555126634-323283e090fa?w=400&q=80",
                "🏪 KB페이로 결제 시 5% 할인\n\n✅ 5,000원 이상 결제 시 사용 가능\n✅ 최대 2,000원\n✅ 전국 GS25 편의점",
                "• 타 할인과 중복 적용 불가\n• 담배·교통카드 충전·공과금 제외\n• 식품·음료·생활용품 전 품목 적용", 182, 30),

            // ── 쇼핑 (오프라인) ──
            build("올리브영 바로할인","OLIVE YOUNG",20000,99999999,8,100,"쇼핑","new",3421,4.6,54,
                "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&q=80",
                "💄 KB페이로 결제 시 8% 할인\n\n✅ 20,000원 이상 결제 시 사용 가능\n✅ 결제금액에 따라 할인 적용 (한도 없음)\n✅ 전국 올리브영 매장",
                "• 타 할인/쿠폰과 중복 적용 불가\n• 인천공항·면세점 제외\n• 뷰티·헬스·생활 전 품목 적용", 56, 30),
            build("이니스프리 바로할인","INNISFREE",15000,5000,7,80,"쇼핑","",2341,4.7,42,
                "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&q=80",
                "🌿 KB페이로 결제 시 7% 할인\n\n✅ 15,000원 이상 결제 시 사용 가능\n✅ 최대 5,000원\n✅ 전국 이니스프리 매장",
                "• 타 할인과 중복 적용 불가\n• 인천공항·면세점 제외\n• 스킨케어·메이크업 전 품목 적용", 34, 30),
            build("신세계백화점 바로할인","SHINSEGAE",50000,99999999,6,50,"쇼핑","end",1543,4.9,27,
                "https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?w=400&q=80",
                "🏬 KB페이로 결제 시 6% 할인\n\n✅ 50,000원 이상 결제 시 사용 가능\n✅ 결제금액에 따라 할인 적용 (한도 없음)\n✅ 전국 신세계백화점",
                "• 타 할인/쿠폰과 중복 적용 불가\n• 일부 명품 브랜드·면세점 제외\n• 패션·뷰티·식품관 전 품목 적용", 23, 30),
            build("홈플러스 바로할인","HOMEPLUS",20000,10000,6,100,"쇼핑","",2187,4.4,43,
                "https://images.unsplash.com/photo-1542838132-92c53300491e?w=400&q=80",
                "🛒 KB페이로 결제 시 6% 할인\n\n✅ 20,000원 이상 결제 시 사용 가능\n✅ 최대 10,000원\n✅ 전국 홈플러스 매장",
                "• 타 할인과 중복 적용 불가\n• 인천공항점·여행 면세 제외\n• 식품·생활·가전 전 품목 적용", 76, 30),

            // ── 문화 (오프라인) ──
            build("롯데시네마 바로할인","LOTTE CINEMA",10000,5000,7,80,"문화","new",3421,4.9,67,
                "https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=400&q=80",
                "🎬 KB페이로 결제 시 7% 할인\n\n✅ 10,000원 이상 결제 시 사용 가능\n✅ 최대 5,000원\n✅ 전국 롯데시네마",
                "• 타 할인/쿠폰과 중복 적용 불가\n• 인천공항·특수관(샤롯데씨어터) 제외\n• 영화 관람권·팝콘 세트 적용", 34, 30),
            build("메가박스 바로할인","MEGABOX",10000,5000,8,60,"문화","hot",2187,4.7,41,
                "https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?w=400&q=80",
                "🍿 KB페이로 결제 시 8% 할인\n\n✅ 10,000원 이상 결제 시 사용 가능\n✅ 최대 5,000원\n✅ 전국 메가박스",
                "• 타 할인/쿠폰과 중복 적용 불가\n• 인천공항·특수관 제외\n• 관람권·푸드 콤보 전 메뉴 적용", 28, 30),

            // ── 생활 (오프라인) ──
            build("GS칼텍스 바로할인","GS CALTEX",30000,99999999,3,60,"생활","",1234,4.4,21,
            ...
            // ── 온라인 ──
            build("쿠팡 배송비 무료","COUPANG",3000,3000,100,300,"쇼핑","hot",12432,4.8,524,
