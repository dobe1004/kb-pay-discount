    ...
    private void initProducts() {
        ...
        List<Product> products = List.of(
            ...
            build("GS칼텍스 주유권 5만원","GS CALTEX",50000,37500,25,40,"생활","end",234,4.4,21,
                ...
                "• 주유 외 세차/편의점 사용 불가\n• 잔액 환불 불가", 3, 60),
            build("11번가 최대 1만원 할인","11ST",10000,6000,40,200,"쇼핑","hot",5621,4.7,412,
                "https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=400&q=80",
                "🛍️ 1만원 이상 구매 시 최대 1만원 할인\n\n✅ 11번가 앱 전용 (온라인)\n✅ 발급일로부터 7일 유효\n✅ 전 상품 적용",
                "• 1만원 이상 구매 시 적용\n• 11번가 앱에서 쿠폰 등록 후 결제 적용\n• 중복 할인 불가", 149, 7),
            ...
            build("홈플러스 상품권 1만원","HOMEPLUS",10000,7000,30,150,"쇼핑","new",654,4.4,43,
                ...
                "• 온라인몰 사용 불가\n• 잔액 환불 불가", 98, 30),
            build("할리스 아메리카노 10잔","HOLLYS",24000,15600,35,120,"카페","hot",1876,4.6,134,
                "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&q=80",
                "☕ 정가 24,000원 → 15,600원 (35% 할인)\n\n할리스 아메리카노 10잔 이용권\n\n✅ 아이스/따뜻한 선택 가능\n✅ 전국 할리스커피 매장 사용\n✅ 발급일로부터 60일 유효",
            ...
            build("CU 편의점 상품권 5천원","CU",5000,3500,30,200,"음식","new",2341,4.2,198,
                ...
                "• 일부 상품 제외\n• 잔액 환불 불가", 127, 14),
            build("빕스 디너 2인 세트","VIPS",58000,40600,30,30,"음식","end",432,4.8,37,
                "https://images.unsplash.com/photo-1544025162-d76694265947?w=400&q=80",
                "🥩 정가 58,000원 → 40,600원 (30% 할인)\n\n빕스 샐러드바 + 스테이크 2인 세트\n\n✅ 전국 빕스 매장 사용\n✅ 발급일로부터 30일 유효\n✅ 주말/공휴일 사용 가능",
                "• 테이크아웃 불가\n• 예약 후 방문 권장", 8, 30),
