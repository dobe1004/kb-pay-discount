...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initProducts() {
        ...
        List<Product> products = List.of(
            ...
            build("bhc 뿌링클 콤보 세트","bhc 치킨",29000,20300,30,200,"음식","hot",3421,4.8,234,
                ...
                "🍗 인기 1위! 뿌링클 콤보\n\nbhc 시그니처 뿌링클 + 콜라 + 치즈볼!",
                "• 전국 bhc 가맹점 이용 가능", 200),
            build("맥도날드 빅맥 세트 2인 교환권","MCDONALDS",18000,10800,40,120,"음식","new",1876,4.5,102,
            ...
            build("야놀자 숙박권 할인쿠폰","YANOLJA",50000,35000,30,150,"생활","hot",2841,4.7,198,
                "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=400&q=80",
                "🏨 국내 숙박 5만원 즉시 할인!",
                "• NOL(야놀자) 앱 전용 · 숙박권 예약 시 적용\n• 최소 결제금액 10만원 이상", 150),
    ...
    private Product build(String name, String brand, int ori, int dis, int rate, int total,
                          ...
                          String img, String desc, String notice, int remaining) {
