...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initProducts() {
        ...
        List<Product> products = List.of(
            ...
            build("맥도날드 빅맥 세트 2인권","MCDONALDS",18000,10800,40,120,"음식","",1876,4.5,102,
            ...
            build("버거킹 와퍼 세트 2인권","BURGER KING",18000,11700,35,100,"음식","hot",2103,4.6,156,
                ...
                "• 매장/포장/딜리버리 모두 가능\n• 세트 구성 변경 불가", 67, 30),
            build("GS칼텍스 주유권 5만원","GS CALTEX",50000,37500,25,40,"생활","",234,4.4,21,
            ...
            build("파리바게뜨 케이크 할인","PARIS BAGUETTE",25000,17500,30,80,"카페","",1234,4.5,76,
            ...
            build("홈플러스 상품권 1만원","HOMEPLUS",10000,7000,30,150,"쇼핑","",654,4.4,43,
            ...
            build("KFC 버켓 세트 할인","KFC",28000,18200,35,60,"음식","",765,4.5,58,
            ...
            build("도미노피자 라지 피자 2판","DOMINOS",44000,28600,35,50,"음식","hot",1123,4.6,95,
                ...
                "• 프리미엄 피자 일부 제외\n• 사이드 메뉴 별도", 29, 30),
            build("이니스프리 3만원 할인쿠폰","INNISFREE",30000,21000,30,40,"쇼핑","",567,4.7,42,
                "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&q=80",
