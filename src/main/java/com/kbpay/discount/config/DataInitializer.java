    ...
    private void initProducts() {
        ...
        List<Product> products = List.of(
            ...
            build("파리바게뜨 케이크 할인","PARIS BAGUETTE",25000,17500,30,80,"카페","new",1234,4.5,76,
                "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Paris_Baguette_logo.svg/200px-Paris_Baguette_logo.svg.png",
                "🎂 정가 25,000원 → 17,500원 (30% 할인)\n\n파리바게뜨 케이크 1개 할인쿠폰\n\n✅ 전국 파리바게뜨 매장 사용\n✅ 발급일로부터 30일 유효",
                "• 일부 시즌 케이크 제외\n• 1인 1매 사용", 44, 30),
            build("롯데리아 버거 세트 2인","LOTTERIA",16000,10400,35,100,"음식","hot",987,4.3,89,
                "https://www.lotteria.com/favicon.ico",
                "🍔 정가 16,000원 → 10,400원 (35% 할인)\n\n롯데리아 버거 세트 2인 교환권\n\n✅ 전국 롯데리아 매장 사용\n✅ 발급일로부터 30일 유효",
                "• 딜리버리 제외, 매장/포장 전용\n• 세트 구성 변경 불가", 67, 30),
            build("GS THE FRESH 상품권 1만원","GS THE FRESH",10000,7000,30,150,"쇼핑","new",654,4.4,43,
                "https://www.gsfresh.com/favicon.ico",
                "🥗 정가 10,000원 → 7,000원 (30% 할인)\n\nGS더프레시 신선식품 전용 1만원 상품권\n\n✅ 전국 GS더프레시 매장 사용\n✅ 발급일로부터 14일 유효",
                "• 온라인몰 사용 불가\n• 잔액 환불 불가", 98, 14),
            build("이디야커피 아메리카노 10잔","EDIYA COFFEE",22000,14300,35,120,"카페","hot",1876,4.6,134,
                "https://www.ediya.com/favicon.ico",
                "☕ 정가 22,000원 → 14,300원 (35% 할인)\n\n이디야커피 아메리카노 10잔 이용권\n\n✅ 아이스/따뜻한 선택 가능\n✅ 전국 이디야 매장 사용\n✅ 발급일로부터 60일 유효",
                "• 전국 이디야커피 매장 이용 가능\n• 일부 한정 음료 제외", 73, 60),
            build("KFC 버켓 세트 할인","KFC",28000,18200,35,60,"음식","hot",765,4.5,58,
                "https://www.kfckorea.com/favicon.ico",
                "🍗 정가 28,000원 → 18,200원 (35% 할인)\n\nKFC 오리지널 버켓 세트 교환권\n\n✅ 전국 KFC 매장 사용\n✅ 발급일로부터 30일 유효",
                "• 매장/포장 전용\n• 딜리버리 시 추가 배달비 발생", 31, 30),
            build("CU 편의점 상품권 5천원","CU",5000,3500,30,200,"음식","new",2341,4.2,198,
                "https://cu.bgfretail.com/favicon.ico",
                "🏪 정가 5,000원 → 3,500원 (30% 할인)\n\nCU 편의점 전용 5천원 상품권\n\n✅ 전국 CU 편의점 사용\n✅ 발급일로부터 14일 유효",
                "• 일부 상품 제외\n• 잔액 환불 불가", 127, 14),
            build("아웃백 스테이크 디너 세트","OUTBACK",55000,38500,30,30,"음식","end",432,4.8,37,
                "https://www.outback.co.kr/favicon.ico",
                "🥩 정가 55,000원 → 38,500원 (30% 할인)\n\n아웃백 스테이크 2인 디너 세트\n\n✅ 전국 아웃백 스테이크하우스 사용\n✅ 발급일로부터 30일 유효\n✅ 주말/공휴일 사용 가능",
                "• 테이크아웃 불가\n• 예약 후 방문 권장", 8, 30),
            build("도미노피자 라지 피자 2판","DOMINOS",44000,28600,35,50,"음식","hot",1123,4.6,95,
                "https://www.dominos.co.kr/favicon.ico",
                "🍕 정가 44,000원 → 28,600원 (35% 할인)\n\n도미노피자 라지 사이즈 2판 교환권\n\n✅ 전국 도미노피자 매장\n✅ 배달/포장/매장 모두 가능\n✅ 발급일로부터 30일 유효",
                "• 프리미엄 피자 일부 제외\n• 사이드 메뉴 별도", 29, 30),
            build("세포라 뷰티 할인쿠폰","SEPHORA",30000,21000,30,40,"쇼핑","new",567,4.7,42,
                "https://www.sephora.kr/favicon.ico",
                "💋 3만원 이상 구매 시 9,000원 할인\n\n세포라 코리아 오프라인/온라인 매장 전용\n\n✅ 전국 세포라 매장 사용\n✅ 발급일로부터 14일 유효",
                "• 세일 상품과 중복 사용 불가\n• 3만원 이상 구매 시 적용", 22, 14),
            build("배스킨라빈스 패밀리 세트","BASKIN ROBBINS",24000,16800,30,90,"카페","hot",1432,4.7,112,
                "https://www.baskinrobbins.co.kr/favicon.ico",
